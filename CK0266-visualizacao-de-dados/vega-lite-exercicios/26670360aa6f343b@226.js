...
~~~
This notebook also exports a \`render(spec)\` method, a convenience method for rendering Vega-Lite JSON specs with the same configuration as the JS API.`
)}

function _render(vl){return(
...
md`To use the API outside of Observable, see the [stand-alone usage instructions](#standalone_use) below.`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("render")).define("render", ["vl"], _render);
